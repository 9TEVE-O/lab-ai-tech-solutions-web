...
const knowledgeCards = [
  {
    ...
    title: 'Safe Intake',
    body:
      'Before information reaches AI systems, it should be classified, reviewed, approved, and traceable. Safe Intake is the controlled entry point.',
    triggers: ['safe intake', 'intake', 'document', 'approval', 'redaction', 'review'],
  },
  {
    id: 'evidence-layer',
    title: 'Evidence Layer',
    body:
      'The Evidence Layer keeps claims connected to source material, review state, support level, and audit trail before outputs are trusted.',
    triggers: ['evidence', 'claim', 'ledger', 'cite', 'audit', 'proof'],
  },
  {
    id: 'runtime-control',
    title: 'Runtime Control',
    body:
      'The runtime control plane defines what an AI system may access, retrieve, remember, execute, pause, block, or escalate.',
    triggers: ['runtime', 'control', 'agent', 'memory', 'permissions', 'state'],
  },
  {
    id: 'cognitive-governance',
    title: 'Cognitive Infrastructure Governance',
    body:
      'The larger pattern is governance of the information environments that AI systems think, remember, retrieve, and act inside.',
...
function buildAnswer(question) {
  ...
  return [
    ...
    '',
    'Boundary: this is a website proof interface, not a production legal, compliance, or security system.',
  ].join('\n');
}
    ...
    <section id="lab-llm" className="page-section section-pad llm-section">
      <div className="section-heading">
        ...
        <p>
          ...
          It demonstrates the intended behaviour before connecting a server-side model.
        </p>
      </div>
